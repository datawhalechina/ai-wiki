...
> ⚠️ 各厂商 Coding Plan 价格和模型覆盖范围变化极快，以下信息为 2026 年 4 月底整理，仅供参考。建议点击链接查看最新定价。
...
| **[腾讯云 Token Plan](https://cloud.tencent.com/act/pro/tokenplan)**              | 腾讯云       | 月费 39 元起          | 覆盖 Tencent HY、GLM、Kimi、MiniMax 等主流模型，兼容 OpenClaw、Claude Code、Cursor 等工具 |
...
- 开始用TokenPlan替换CodingPlan了，且买且珍惜
